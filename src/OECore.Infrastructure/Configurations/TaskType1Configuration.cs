...
public class TaskType1Configuration : IEntityTypeConfiguration<TaskType1>
{
    public void Configure(EntityTypeBuilder<TaskType1> builder)
    {
        builder.ToTable("tblTaskType1");
        ...
        // Relationship
        builder.HasOne(e => e.TaskType).WithMany(e => e.TaskType1).HasForeignKey(e => e.TaskTypeId).OnDelete(DeleteBehavior.Restrict);
    }
}
